...
import lfmc.library.geoserver.workspace as ws
from lfmc.library.geoserver.resource import featuretype_from_index, coverage_from_index, \
    wmslayer_from_index
from lfmc.library.geoserver.support import ResourceInfo, xml_property, key_value_pairs, \
